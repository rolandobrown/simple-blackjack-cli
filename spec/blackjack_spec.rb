RSpec.describe "#welcome" do
  it "prints a welcome message to screen" do
    expect($stdout).to receive(:puts).with("Welcome to Wu-Tang Blackjack!")
    welcome
  end
end

RSpec.describe "#deal_card" do
...
RSpec.describe "#display_card_total" do
...
RSpec.describe "#get_user_input" do
...
RSpec.describe "#initial_round" do
